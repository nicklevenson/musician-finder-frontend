...
class Notification extends React.Component {
  ...
  makeRead = (e) => {
    ...
    fetch(
      `${process.env.REACT_APP_BACKEND_URL}/notifications/make_read`,
      configObj
    );
  ...
  render() {
    return (
      <Feed.Event
        ...
        onClick={this.props.notification.read ? null : (e) => this.makeRead(e)}
        className="notification"
      >
        <Link
          to={
            this.props.notification.involved_user_id
              ? "/users/" + this.props.notification.involved_user_id
              : "/notifications"
          }
        >
          {/* <Feed.Label>
